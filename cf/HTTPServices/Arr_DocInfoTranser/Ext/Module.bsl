...
Функция v1GET_gate(Запрос)
	УстановитьПривилегированныйРежим(Истина); //Привилегированный режим позволит методам API работать даже с авторизацией под служебным пользователем, у которого нет интерактивных прав на запрашиваемые данные
	Ответ = Новый HTTPСервисОтвет(200);
